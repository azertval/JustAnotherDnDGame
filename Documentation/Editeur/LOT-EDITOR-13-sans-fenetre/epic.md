...
> gestes d'entité et la copie (voir plus bas) ; **étape CI de rendu éprouvée à la première PR** qui
> change une carte.
> Prérequis : `LOT-EDITOR-04`. Feuille de route : [éditeur](@ref roadmap-editeur).
> Alimente : `LOT-EDITOR-06` (fin des scripts), `LOT-EDITOR-09` (monde).
...
- **La CI publie le rendu PNG des cartes qu'une PR change.** Étape écrite, commande éprouvée au
  ...
  **à voir tourner à la première PR qui touche une carte** — celle-ci n'en touche aucune.

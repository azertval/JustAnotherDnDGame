...
> `lot-editor-12-format-v4`, en quatre commits : le format dans `Core` (phase 1), `--migrate` et
> `--check` avec les trois cartes migrées (phase 2), le schéma et le fuzz (phase 3), puis la
> documentation. Vérification automatisée : construction `/W4 /WX` sans avertissement, tests
> unitaires verts (788), acceptation sur les trois cartes livrées, `LevelEditor --check` vert, les
> deux scripts de cartes verts, une minute de fuzz sans défaut.
> Prérequis : `LOT-EDITOR-01`. Feuille de route : [éditeur](@ref roadmap-editeur).
> Alimente : `LOT-EDITOR-03`, `LOT-EDITOR-05`.
> Exigences : `EX-LVL-019`, `EX-LVL-020`, `EX-LVL-021`, `EX-LVL-022`, `EX-LVL-023`,
> `EX-LVL-024`, `EX-EDIT-062` (nouvelles) ; `EX-LVL-003`,
> `EX-LVL-005`, `EX-LVL-016` et `EX-EDIT-043` révisées.
...
| 4 — documentation | ce dossier, la feuille de route, `niveaux.md`, `editeur-niveaux.md`, le README des niveaux, le cahier de tests |

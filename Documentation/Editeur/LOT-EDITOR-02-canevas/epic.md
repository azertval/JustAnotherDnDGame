...
> la vérification des gestes à la souris (voir les critères d'acceptation).
...
| 3 — documentation | ce dossier, la feuille de route, `editeur-niveaux.md`, les guides et les README |

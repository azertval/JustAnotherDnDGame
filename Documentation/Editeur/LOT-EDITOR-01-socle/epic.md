...
> souris (voir la dernière section).
> Prérequis : aucun. Feuille de route : [éditeur](@ref roadmap-editeur).
> Alimente : `LOT-EDITOR-02`, `LOT-EDITOR-12`, `LOT-EDITOR-10`.
...
| 4 — documentation | ce dossier, la feuille de route, `editeur-niveaux.md`, `interface-ihm.md`, les guides et les README |
...
- **Modifier le JSON d'une carte ouverte et modifiée fait proposer « recharger » ou « garder », sans
  rien perdre de l'un ni de l'autre.** ✔ pour la mécanique (`DiskGuardTest`,

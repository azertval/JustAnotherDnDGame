# LOT-87 — Cahier des assets de la charte v2 {#lot-87-cahier-assets}

> Tâche **T2.4** du [LOT-87](@ref lot-87). Source : `assets-brief.json`, son contrat
> `assets-brief.schema.json`, son garde-fou `scripts/check_assets_brief.py`.
> Exigences servies : [`EX-IHM-075`](@ref EX-IHM-075) (ornements produits, décrits par ce cahier),
> [`EX-IHM-076`](@ref EX-IHM-076) (provenance « produite »), [`EX-IHM-053`](@ref EX-IHM-053)

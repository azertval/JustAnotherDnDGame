...
> 974/974, `clang-format`, les six lints, cahier de test et Doxygen verts).
> Prérequis : [`LOT-32`](@ref lot-32). Alimente [LOT-13](@ref lot-13), [LOT-21](@ref lot-21),
> [LOT-23](@ref lot-23), [LOT-27](@ref lot-27), `LOT-46`.
...
- **Douze** profils sont rejoués — classe d'armure, points de vie, vitesse, facteur de puissance,
  dégâts de l'attaque principale — contre des valeurs recopiées à la main du PDF. ✔
- Une extraction incomplète **arrête** la génération plutôt que de livrer un catalogue amputé :
  sommaire confronté au corps, gouttière re-vérifiée, six caractéristiques exigées, sept étiquettes
  de profil exigées. ✔

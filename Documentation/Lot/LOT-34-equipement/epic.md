...
> 1008/1008, `clang-format`, les six lints, cahier de test et Doxygen verts).
> Prérequis : [`LOT-32`](@ref lot-32). Alimente [LOT-14](@ref lot-14), [LOT-26](@ref lot-26),
> [LOT-27](@ref lot-27).
>
> Exigences couvertes : [`EX-INV-001`](@ref EX-INV-001), [`EX-INV-010`](@ref EX-INV-010),
> [`EX-INV-011`](@ref EX-INV-011), [`EX-INV-041`](@ref EX-INV-041).
...
- **La CA calculée par le moteur pour chacune des 13 armures égale la colonne CA de la table**,
  vérifié par un test dont les valeurs sont recopiées à la main du livre. ✔
- **Le poids total d'un inventaire de départ correspond au calcul manuel** — cotte de mailles, épée
  longue, bouclier et deux javelines : 27,5 + 1,5 + 3 + 2 × 1 = **34 kg**. ✔

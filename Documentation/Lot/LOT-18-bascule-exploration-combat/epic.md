...
> 1047/1047, `clang-format`, les huit lints, cahier de test et Doxygen verts).
> Prérequis : [LOT-05](@ref lot-05) (modes de jeu), [LOT-10](@ref lot-10) (déclencheurs et drapeaux
> de monde), [LOT-13](@ref lot-13) (fiches des combattants).
>
...
- **Un ennemi vaincu ne réapparaît pas**, y compris après avoir quitté et rechargé la carte — c'est
  un drapeau de monde, qui survit à la destruction de l'entité. ✔
- **Une fuite ramène à l'exploration sans que l'ennemi soit marqué vaincu.** ✔ (la défaite non plus)

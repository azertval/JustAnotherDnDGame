...
> Statut : **fait** (vérification automatisée : `scripts/lint_lots.py` vert, règle 12 comprise ;
> `scripts/lint_exigences.py` vert ; Doxygen vert).
...
- Le lint **refuse** un renvoi vers un numéro de lot inexistant — vérifié en injectant `LOT-99`
  dans `vision.md` et en observant l'échec, puis en restaurant. ✔

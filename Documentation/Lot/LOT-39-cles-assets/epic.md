...
> 1056/1056, `clang-format`, les neuf lints, cahier de test et Doxygen verts).
> Prérequis : `LOT-33`, `LOT-34`, `LOT-37`, [LOT-38](@ref lot-38).
>
> Aucune exigence ajoutée : `EX-CNT-040` et `EX-CNT-041` couvrent ce lot, et c'est leur premier
> emploi.
...
- **Aucune clé d'asset orpheline dans les catalogues.** ✔ (vérifié par test *et* par lint, dans les
  deux sens — clé sans donnée, image sans clé)

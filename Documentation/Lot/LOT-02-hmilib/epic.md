# LOT-02 — Bibliothèque `HmiLib` {#lot-02}

> Statut : **en cours**.
> Prérequis : [LOT-01](@ref lot-01).
...
- `Source/Test/CMakeLists.txt` ne contient plus que les **quatre** chemins `../HMI/…`
  conditionnels à Qt.
- Build complet sans avertissement en `/W4 /WX` ; tests intégralement verts, **sans modification
  du corps d'un seul test** (refactoring à comportement constant).

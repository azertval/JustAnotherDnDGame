# LOT-91 — Preuve de concept : cinq planches à la main {#lot-91-poc}

> Tâche **T0** du [LOT-91](@ref lot-91). Ce document est un **protocole** : chaque étape est
...
- **16 septembre, après le verdict (décision de l'utilisateur).** Le PoC prouve la méthode PNJ par PNJ,
  ...
  méthode, **sans essai en jeu de chaque modèle**. L'[epic](@ref lot-91) est réécrit autour de la méthode

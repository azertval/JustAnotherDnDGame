...
Ce guide s'adresse aux **joueurs** : naviguer dans les menus, parcourir le monde et combattre au
Colisée.
...
**Nouvelle partie** ouvre la partie dans la **Capitale**, à une porte de **Martpart**, le quartier
du marché : le personnage y paraît, et l'on parcourt le quartier.
...
**portails** : une avenue relie Martpart à **Arenarea**, le quartier du Colisée. Parler à un
personnage ouvre un **dialogue** — les sentinelles expliquent pourquoi les autres quartiers restent
fermés.

Les boutons du bandeau ouvrent l'inventaire, le journal, la **carte** (monde, région, ville) et les
options.

## Combattre au Colisée

Au **Colisée**, le héraut envoie combattre sur le sable ; on revient ensuite sur la carte, au même
endroit. Le combat se joue au tour par tour, sur une grille.
...
La souris et la manette pilotent le même curseur.

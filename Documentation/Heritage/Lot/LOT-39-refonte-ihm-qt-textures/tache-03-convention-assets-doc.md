...
`JustAnotherRpgGame.exe --export-atlas=<chemin>.png` (`Source/HMI/main.cpp`), documenté dans
...
verts ; build `/W4 /WX` propre (`JustAnotherRpgGame`, `UnitTests`, `IntegrationTests`, `SystemTests`) ;

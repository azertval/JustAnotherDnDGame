# Personnage et progression {#spec-rpg}
...
- \anchor EX-RPG-001 **EX-RPG-001** — La fiche de personnage est un **agrégat dérivé** : espèce,
...
- \anchor EX-RPG-002 **EX-RPG-002** — Un changement de source doit **recalculer** l'agrégat, jamais
...
- \anchor EX-RPG-010 **EX-RPG-010** — Une **espèce** est entièrement une donnée : ajustements de
...
- \anchor EX-RPG-011 **EX-RPG-011** — Un **historique** accorde des maîtrises, des langues, un
...
- \anchor EX-RPG-020 **EX-RPG-020** — Une **classe** déclare son dé de vie, ses maîtrises, ses
...
- \anchor EX-RPG-022 **EX-RPG-022** — Une **sous-classe** se greffe sur sa classe mère **sans la
...
- \anchor EX-RPG-023 **EX-RPG-023** — Ajouter une classe ne doit demander de modifier **aucun**
...
- \anchor EX-RPG-031 **EX-RPG-031** — Le passage de niveau se fait au **franchissement d'un seuil**,
...
- \anchor EX-RPG-032 **EX-RPG-032** — Aucune progression ne doit être liée au **franchissement d'un
...
- \anchor EX-RPG-040 **EX-RPG-040** — Les **dons** sont une donnée, et déclarent leurs conditions
...
- \anchor EX-RPG-041 **EX-RPG-041** — Le **multiclassage** déclare ses conditions de caractéristique,
...
- \anchor EX-RPG-042 **EX-RPG-042** — Les **langues** sont une donnée, accordée par espèce,
...
- \anchor EX-RPG-050 **EX-RPG-050** — Le C++ ne porte que des **mécanismes de sort** — dégâts de
...
- \anchor EX-RPG-051 **EX-RPG-051** — Un sort dont l'effet n'entre dans aucun mécanisme se déclare
...
- \anchor EX-RPG-052 **EX-RPG-052** — Le moteur doit admettre **plusieurs systèmes d'emplacements de

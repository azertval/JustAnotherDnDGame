...
- \anchor EX-REG-001 **EX-REG-001** — Toute résolution incertaine passe par un **d20 auquel
...
- \anchor EX-REG-002 **EX-REG-002** — L'**avantage** et le **désavantage** se résolvent en lançant
...
- \anchor EX-REG-003 **EX-REG-003** — Tout jet doit être **restituable** : le dé obtenu, les
...
- \anchor EX-REG-010 **EX-REG-010** — Un personnage et une créature portent **six caractéristiques**
...
- \anchor EX-REG-011 **EX-REG-011** — Le **bonus de maîtrise** dépend du niveau et de rien d'autre.
...
- \anchor EX-REG-012 **EX-REG-012** — La liste des **compétences** et la caractéristique associée à
...
- \anchor EX-REG-020 **EX-REG-020** — Le moteur distingue le **test de caractéristique** (le
...
- \anchor EX-REG-021 **EX-REG-021** — Un **seuil de difficulté** est déclaré par une **échelle
...
- \anchor EX-REG-030 **EX-REG-030** — La partie porte une **horloge de jeu déterministe** : le temps
...
- \anchor EX-REG-031 **EX-REG-031** — Le repos existe en deux formes, **court** et **long**, et
...
- \anchor EX-REG-032 **EX-REG-032** — Un repos **interrompu** ne restaure **rien**. Une restauration
...
- \anchor EX-REG-040 **EX-REG-040** — Une condition n'est **pas un drapeau** posé sur la fiche :
...
- \anchor EX-REG-041 **EX-REG-041** — Chaque condition du catalogue doit avoir un **effet
...
- \anchor EX-REG-050 **EX-REG-050** — Toute créature porte un **facteur de puissance** sur une
...
- \anchor EX-REG-051 **EX-REG-051** — Une case vaut **1,5 m**, en exploration comme en combat.

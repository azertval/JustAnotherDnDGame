# Inventaire et économie {#spec-inventaire}

> Statut : **à faire** (`LOT-77` écrit ce document ; `LOT-14`, `LOT-26`, `LOT-34` et `LOT-82`
> l'implémentent). Dépend de [`rpg.md`](@ref spec-rpg) (l'agrégat de fiche) et de
...
- \anchor EX-INV-001 **EX-INV-001** — L'inventaire est une liste d'**identifiants de catalogue**
...
- \anchor EX-INV-010 **EX-INV-010** — L'équipement porté occupe des **emplacements typés** (main
...
- \anchor EX-INV-011 **EX-INV-011** — La **classe d'armure** est dérivée de l'équipement porté selon
...
- \anchor EX-INV-020 **EX-INV-020** — L'**encombrement** est dérivé du poids total porté et de la
...
- \anchor EX-INV-030 **EX-INV-030** — La **monnaie** est à taux fixes et déclarés. Toute somme est
...
- \anchor EX-INV-031 **EX-INV-031** — Les prix d'**achat** et de **vente** sont distincts, et
...
- \anchor EX-INV-040 **EX-INV-040** — Le **butin** est composé par table, et **reproductible à
...
- \anchor EX-INV-041 **EX-INV-041** — Un **objet magique** déclare sa **rareté** et, le cas échéant,

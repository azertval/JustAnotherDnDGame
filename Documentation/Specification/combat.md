...
- \anchor EX-CBT-001 **EX-CBT-001** — Le passage exploration ↔ combat est **explicite et
...
- \anchor EX-CBT-010 **EX-CBT-010** — L'ordre de jeu est déterminé par un jet d'**initiative** en
...
- \anchor EX-CBT-011 **EX-CBT-011** — Un tour offre une **action**, une **action bonus**, une
...
- \anchor EX-CBT-012 **EX-CBT-012** — La fin d'un tour est **explicite**. Un tour qui se termine
...
- \anchor EX-CBT-020 **EX-CBT-020** — Le déplacement d'un tour est borné par une **portée en cases**
...
- \anchor EX-CBT-021 **EX-CBT-021** — Une attaque à distance suppose une **ligne de vue**, calculée
...
- \anchor EX-CBT-022 **EX-CBT-022** — Une arme déclare son **allonge** ou sa **portée**, et le
...
- \anchor EX-CBT-031 **EX-CBT-031** — Un **20 naturel** est une réussite critique : les **dés** de
...
- \anchor EX-CBT-032 **EX-CBT-032** — Les dégâts sont **typés**, et une cible peut y être
...
- \anchor EX-CBT-040 **EX-CBT-040** — À **0 point de vie**, un personnage tombe **inconscient** et
...
- \anchor EX-CBT-041 **EX-CBT-041** — Un soin qui ramène au-dessus de 0 **réinitialise** le compteur
...
- \anchor EX-CBT-050 **EX-CBT-050** — L'intelligence artificielle choisit **dans les mêmes actions

...
Usage :
  python scripts/check_json_files.py FICHIER...   (fichiers passés par pre-commit)
  python scripts/check_json_files.py --all        (tous les .json suivis)
  python scripts/check_json_files.py --auto-test
"""
import argparse
import json
import os

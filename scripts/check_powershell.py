...
Windows PowerShell 5.1. Règles : `scripts/PSScriptAnalyzerSettings.psd1`.
...
Usage :
  python scripts/check_powershell.py            tous les .ps1 suivis par git
  python scripts/check_powershell.py FICHIER...
"""
import argparse
import json
import os
...
SETTINGS = os.path.join('scripts', 'PSScriptAnalyzerSettings.psd1')

...
Usage :
  python scripts/merge_sarif.py analyze-sarif/ -o msvc-analyze.sarif --title "MSVC /analyze"
  python scripts/merge_sarif.py cppcheck.sarif -o cppcheck-merged.sarif --summary resume.md
  python scripts/merge_sarif.py --auto-test
"""
import argparse
import json
import os

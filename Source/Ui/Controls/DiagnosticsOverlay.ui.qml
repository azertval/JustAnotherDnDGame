...
/*!
    Compteur de diagnostic -- recouvrement, cote conception (LOT-86).

    La mesure de cadence est volontairement hors du formulaire. Le runtime pose la valeur de
    `readoutText`; ce fichier reste donc entierement editable dans Qt Design Studio.
*/
Item {
    id: overlay

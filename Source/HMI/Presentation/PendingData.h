...
#include "HMI/Presentation/SheetRowModel.h"

class QAbstractItemModel;

/**
 * @file HMI/Presentation/PendingData.h
 ...
 *
 * `python scripts/list_pending_bindings.py` relève toutes les clés depuis le QML lui-même. Aucune
